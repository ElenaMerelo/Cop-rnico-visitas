---
title: "Evolución temporal del efecto Twitter en las visitas a una página de la Wikipedia."
author: "JJ Merelo"
date: "14 de enero de 2017"
output: pdf_document
bibliography: refs.bib
abstract: "A consecuencia de un vídeo que se ha hecho viral en estos días y en el
  que se menciona a Copérnico, la figura ha recibido una cantidad considerable
  de atención, pero fue decayendo rápidamente en los días siguientes
  hasta desaparecer de los primeros puestos a los tres días. Veamos exactamente
  cuanta y cómo ha evolucionado a lo largo del tiempo. También compararemos con otros
  casos de notoriedad recientes, concluyendo que la duración de una semana se repite,
  con mucha aproximación, para los documentos examinados. \n"
---
...
Que sepamos, hasta el momento no ha habido demasiados estudios que analicen un efecto similar de las redes sociales, quizás porque ya no provocan ese efecto en los sitios web; mucho menos el efecto que tienen en la búsqueda o *ocupación mental* de conceptos. También es cierto que la analítica web es hoy en día mucho más complicada y que, en general, no se revelan públicamente las visitas a un sitio. Actualmente interesa más analizar los *trending topic* en redes sociales. Pero no se ha estudiado qué efecto tienen estos *trending topic* en la ocupación mental del público reflejada en su comportamiento de navegación en Internet.
...
El resto del trabajo se organiza de esta forma: A continuación se presenta la metodología que se ha seguido para capturar y analizar los datos; luego se analizan las visitas de la página de la Wikipedia y otras páginas relacionadas, así como la evolución en su ránking de páginas vistas en la Wikipedia. Finalmente, tratamos de sacar una serie de conclusiones.
...
En el año 2016 hay una tasa ligeramente inferior a 2, es decir, que la página de la teoría heliocéntrica recibe aproximadamente la mitad de visitas que la de Copérnico, con no demasiadas variaciones; cabe suponer que hay más interés por el personaje que por su aportación, aunque tampoco demasiado. No obstante, cuando el asunto "Copérnico-Ojeda" estalla, de repente las personas se interesan por el personaje, sin preocuparse demasiado por comprender cuál fue su aportación a la ciencia. Cabe señalar que no sabemos si se tratan de las mismas personas porque no se sabe el camino que siguen en la Wikipedia, aunque es razonable suponer que un porcentaje considerable de las que visiten cualquiera de las dos páginas acabará siguiendo los enlaces para ir a la otra. El enlace a la teoría aparece en las primeras líneas de la página de Copérnico y es el décimo tercer enlace desde el principio de la página, mientras que Copérnico aparece en el segundo párrafo de la página de la teoría siendo más o menos el mismo número de enlace, el décimo en este momento. 

Veamos también, como control, otra página, la de Galileo Galilei, que fue quien difundió la teoría heliocéntrica. No aparece de ninguna manera en el incidente pero puede ser interesante para ver el interés que se tiene en este tipo de páginas y si hay una derivación de interés de una a otra. 
...
Aparte de la curiosidad de cómo evolucionan de la misma forma, con una caída considerable el día 7, no hay ninguna tendencia clara ni cabe suponer que las páginas con este tipo de contenido hubieran tenido un interés creciente del año pasado a este y, de hecho, el día 12 ya hay menos visitas en la página de Galileo que el año anterior. Aunque puede que sí haya habido una cierta transferencia de interés y por tanto de visitas de una a otra, ya que la de Galileo está enlazadas desde la de Copérnico, el hecho de que no haya cambios en el mismo sentido que la de Copérnico descarta un interés súbito en la ciencia del renacimiento y la teoría heliocéntrica como una causa del aumento de visitas que habrá que atribuir, por tanto, al incidente que estamos tratando. 

Por otro lado, examinamos también las visitas de la página de Meryl Streep, cuyo discurso durante los Globos de Oro tuvo una notoriedad considerable, al igual que la reacción posterior del presidente electo. Se trata, en este caso, de una página que, de por sí, tiene bastantes visitas, como se ve a continuación.
